...
200 is correct only when the target had 200 HP left (or the display refers to a
different event); it is not a valid full-health 400-alpha penetration. The
regression test fixes the low roll at 300 against an 880-HP target and verifies
580 HP remaining, 300 direct damage and 300 settlement damage.
