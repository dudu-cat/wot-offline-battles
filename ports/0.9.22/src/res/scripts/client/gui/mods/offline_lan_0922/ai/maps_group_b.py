...
# 15_komarin: two outer banks are safer than attempting a water crossing.
KOMARIN = _map('15_komarin', (-400.0, -400.0, 400.0, 400.0),
	(60.0, -340.0), (-107.0, 342.0), (
		_route('west_bank', 4, 0.54, _weights(.50, .82, .55, .70, .38, .08),
			((35, -315, 0), (-105, -295, 0), (-255, -230, 0), (-300, -95, 1), (-285, 55, 1), (-205, 190, 1), (-120, 300, 0))),
		_route('east_bank', 4, 0.68, _weights(.72, .42, .90, .16, .72, .00),
			((80, -320, 0), (190, -270, 0), (275, -150, 1), (275, 0, 1), (225, 145, 1), (90, 275, 0))),
		_route('central_bridge', 3, 0.82, _weights(.92, .75, .30, .10, .15, .00),
			((55, -310, 0), (10, -230, 0), (-5, -120, 1), (-12, -20, 1), (-35, 85, 1), (-85, 245, 0))),
	))
...
WESTFELD = _map('23_westfeld', (-500.0, -500.0, 500.0, 500.0),
	(363.6, -369.9), (-286.2, 278.8), (
		_route('north_ridge', 3, 0.67, _weights(.34, .75, 1.00, .82, .82, .00),
			((345, -350, 0), (245, -260, 0), (110, -155, 1), (-35, -65, 1), (-165, 75, 1), (-270, 260, 0))),
		_route('valley_road', 5, 0.75, _weights(.95, .72, .34, .12, .20, .00),
			((345, -350, 0), (235, -325, 0), (105, -245, 1), (-20, -120, 1), (-145, 45, 1), (-270, 260, 0))),
		_route('south_fields', 4, 0.50, _weights(.45, .88, .58, 1.00, .46, .16),
			((345, -350, 0), (220, -405, 0), (55, -390, 0), (-100, -295, 1), (-210, -105, 1), (-275, 250, 0))),
	))


DESERT = _map('28_desert', (-500.0, -500.0, 500.0, 500.0),
	(102.9, 295.6), (-432.6, -302.0), (
		_route('north_dunes', 3, 0.69, _weights(.30, .70, 1.00, .76, .92, .00),
			((95, 280, 0), (-25, 345, 0), (-180, 315, 1), (-305, 185, 1), (-390, -30, 1), (-420, -285, 0))),
		_route('village_road', 5, 0.78, _weights(.92, .78, .36, .14, .24, .00),
			((95, 280, 0), (20, 185, 0), (-85, 85, 1), (-175, -35, 1), (-285, -165, 1), (-420, -285, 0))),
		_route('south_rocks', 4, 0.56, _weights(.50, .86, .60, 1.00, .46, .12),
			((95, 280, 0), (150, 105, 0), (80, -55, 1), (-65, -175, 1), (-245, -275, 1), (-420, -285, 0))),
	))


EL_HALLOUF = _map('29_el_hallouf', (-500.0, -500.0, 500.0, 500.0),
	(-282.7, -397.3), (424.0, 287.1), (
		...
		_route('north_ridge', 3, 0.65, _weights(.30, .70, 1.00, .92, .88, .00),
			((-270, -375, 0), (-320, -195, 0), (-245, 0, 1), (-100, 155, 1), (135, 245, 1), (410, 275, 0))),
	))
