...
The corridor skeleton is inherited from the final pinned 0.8.2 implementation.
The two base coordinates below are the standard-mode starts decoded from the
#1513 ``04_himmelsdorf`` arena definition:

* bounds: (-300, -300) -> (400, 400)
* team 1 ctf base: south, approximately (2.5, -252.6)
* team 2 ctf base: north, approximately (69.1, 349.0)
...
HIMMELSDORF = {
	...
	'bases': {
		1: (2.499999, -252.600143),
		2: (69.099930, 348.999969),
	},
	'routes': {
		1: (
			{
