...
Version `0.3.41` replaces the old compatibility slice. It is a server-backed
...
`0.3.41` installs one copied pose before native input startup and feeds that
...
```text
org.peng.offline_lan_0922_0.3.41.wotmod
org.peng.offline_lan_0922_0.3.41.wotmod.sha256
